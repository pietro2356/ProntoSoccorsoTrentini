...
## <small>1.3.1 (2025-08-02)</small>

* fix(core): :sparkles: add async animations and PrimeNG theme configuration ([fe8ada9](https://github.com/pietro2356/ProntoSoccorsoTrentini/commit/fe8ada9))
* fix(dependencies): :bug: update PrimeNG and related packages to latest versions ([15fb5e3](https://github.com/pietro2356/ProntoSoccorsoTrentini/commit/15fb5e3))
* fix(firebase-hosting): :bug: update npm install command and add testing step ([3e34962](https://github.com/pietro2356/ProntoSoccorsoTrentini/commit/3e34962))
* fix(firebase-hosting): :bug: update npm install command to use --legacy-peer-deps ([de74d42](https://github.com/pietro2356/ProntoSoccorsoTrentini/commit/de74d42))
* fix(styles): :bug: remove unused PrimeNG theme and styles imports from global.scss ([dac6deb](https://github.com/pietro2356/ProntoSoccorsoTrentini/commit/dac6deb))
* fix(waiting-box): :bug: handle NaN values in waitVal display ([97c0e99](https://github.com/pietro2356/ProntoSoccorsoTrentini/commit/97c0e99))
...
- fix(firebase-hosting): :bug: update npm install command and add testing step [`3e34962`](https://github.com/pietro2356/ProntoSoccorsoTrentini/commit/3e349624c6cbd9c17975d075f67e014773a850d6)
